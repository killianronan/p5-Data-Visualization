...
let values = [];
// let values = [1,2,5,1,24,4,556,43,54324,123,124,,54,5,431,5,2,54,6,22131,211,73,1,7,2,1,79,74,1245,66,22,221,4];
...
function draw() {
  background(255);
  text("Best Time Complexity: O(n logn)", 10, 10)
  text("Worst Time Complexity: O(n^2)", 10, 10)
  ...
  for(let i = 0; i < values.length; i++) {
    ...
    rect(i * 8, (height-50) - values[i], 8, values[i]);
   }
}
