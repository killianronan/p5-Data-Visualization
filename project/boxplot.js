...
function setup() {
  ...
  time = table.getColumn("competitorname")
  ratings = table.getColumn("sugarpercent")

  title = "Sugar Percentage of Candy"
...
function drawTitle() {
  ...
  textAlign(CENTER)
  textStyle(BOLD)
  text(title, GRAPH_ORIGINX+50, GRAPH_ORIGINY - 50, textLen + 50, 20)
}
